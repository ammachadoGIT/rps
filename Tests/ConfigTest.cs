...
namespace Tests
{
    public sealed class ConfigTest
    {
        ...
        {
            // Test a null path.
            var arguments = Config.GetArguments(null);
        ...
        public void Config_Valid()
        {
            ...
            var config = Config.ParseArguments("{ \"serverURL\" : \"https://www.mparticle.com\" , \"targetRPS\" : 10, \"authKey\" : \"Whatever\", \"userName\" : \"Fred\"}");
        ...
        public void Config_MissingRequired()
        {
            ...
            var config = Config.ParseArguments("{ \"targetRPS\" : 10, \"authKey\" : \"Whatever\", \"userName\" : \"Fred\" }");
            Assert.Null(config);
        ...
        public void Config_InvalidValues()
        {
            ...
            var config = Config.ParseArguments("{ \"serverURL\" : \"https://www.mparticle.com\" , \"targetRPS\" : 0, \"authKey\" : \"Whatever\", \"userName\" : \"Fred\"}");
            Assert.Null(config);
